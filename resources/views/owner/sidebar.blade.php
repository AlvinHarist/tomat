<aside class="sidebar">
    ...
    <nav class="nav-links">
        ...
        <a href="{{ route('owner.categories.index') }}"><i class="fas fa-box-open"></i> Categories</a>        
        
        <form action="{{ route('owner.logout') }}" method="POST" style="margin-top: 20px;">
            @csrf
            <button type="submit" style="background:none; border:none; color:#777; cursor:pointer; font-size:0.9rem; padding:12px 15px; display:flex; align-items:center; width: 100%;">
