        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow">
                ...
                <p class="text-gray-600 text-sm mb-4">
                    Laporan daftar produk berdasarkan jumlah stock yang tersedia.
                </p>
            ...
            <div class="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow">
                    ...
                    <div class="w-12 h-12 bg-yellow-100 rounded-full flex items-center justify-center">
                        <svg class="w-6 h-6 text-yellow-600" fill="none" stroke="currentColor"
                            ...
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                  ...
                                  1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674
                                  a1 1 0 00-.363-1.118L2.98 9.1c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z"></path>
                        </svg>
                    </div>
                    <div class="ml-4">
                ...
                <p class="text-gray-600 text-sm mb-4">
                    Laporan daftar produk berdasarkan rating dan jumlah review pelanggan.
                </p>
            ...
            <!-- Report Card 3: Produk Perlu Restock -->
            <div class="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow">
                <div class="flex items-center mb-4">
                ...
                <p class="text-gray-600 text-sm mb-4">
                    Laporan produk dengan stock menipis yang perlu segera di-restock.
                </p>
